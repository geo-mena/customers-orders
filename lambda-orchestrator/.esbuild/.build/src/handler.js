...
var require_form_data = __commonJS({
    '../node_modules/.pnpm/form-data@4.0.4/node_modules/form-data/lib/form_data.js'(
        ...
        FormData3.prototype._multiPartHeader = function (field, value, options) {
            ...
            return (
                '--' + this.getBoundary() + FormData3.LINE_BREAK + contents + FormData3.LINE_BREAK
            );
        };
...
__export(handler_exports, {
    createAndConfirmOrder: () => createAndConfirmOrder
});
...
// ../node_modules/.pnpm/axios@1.13.1/node_modules/axios/lib/platform/node/classes/FormData.js
...
// ../node_modules/.pnpm/axios@1.13.1/node_modules/axios/lib/platform/node/index.js
var import_crypto = __toESM(require('crypto'), 1);

// ../node_modules/.pnpm/axios@1.13.1/node_modules/axios/lib/platform/node/classes/URLSearchParams.js
...
// ../node_modules/.pnpm/axios@1.13.1/node_modules/axios/lib/adapters/http.js
...
// ../node_modules/.pnpm/axios@1.13.1/node_modules/axios/lib/helpers/fromDataURI.js
...
// ../node_modules/.pnpm/axios@1.13.1/node_modules/axios/lib/helpers/AxiosTransformStream.js
...
// ../node_modules/.pnpm/axios@1.13.1/node_modules/axios/lib/helpers/formDataToStream.js
var import_util = __toESM(require('util'), 1);
var import_stream2 = require('stream');

// ../node_modules/.pnpm/axios@1.13.1/node_modules/axios/lib/helpers/readBlob.js
...
var textEncoder =
    typeof TextEncoder === 'function' ? new TextEncoder() : new import_util.default.TextEncoder();
var CRLF = '\r\n';
...
// ../node_modules/.pnpm/axios@1.13.1/node_modules/axios/lib/helpers/ZlibHeaderTransformStream.js
...
// ../node_modules/.pnpm/axios@1.13.1/node_modules/axios/lib/helpers/callbackify.js
...
// ../node_modules/.pnpm/axios@1.13.1/node_modules/axios/lib/helpers/estimateDataURLDecodedBytes.js
...
var { HTTP2_HEADER_SCHEME, HTTP2_HEADER_METHOD, HTTP2_HEADER_PATH, HTTP2_HEADER_STATUS } =
    import_http2.constants;
        ...
        if ((authoritySessions = this.sessions[authority])) {
            ...
            for (let i = 0; i < len; i++) {
                ...
                if (
                    ...
                    import_util2.default.isDeepStrictEqual(sessionOptions, options)
                ) {
                    return sessionHandle;
                }
            }
        }
        const session = (0, import_http2.connect)(authority, options);
        let removed;
        const removeSession = () => {
            if (removed) {
                return;
            ...
            removed = true;
            let entries2 = authoritySessions,
                len = entries2.length,
                i = len;
            while (i--) {
    ...
    function httpAdapter(config) {
        return wrapAsync(async function dispatchHttpRequest(resolve, reject, onDone) {
            ...
            if (Number.isNaN(httpVersion)) {
                throw TypeError(
                    `Invalid protocol version: '${config.httpVersion}' is not a number`
                );
            }
            ...
            onDone((response, isRejected) => {
                ...
                if (
                    data2 instanceof import_stream4.default.Readable ||
                    data2 instanceof import_stream4.default.Duplex
                ) {
...
// src/services/customersApiClient.ts
var CustomersApiClient = class {
    client;
    constructor(baseURL, serviceToken2) {
        this.client = axios_default.create({
            baseURL,
            headers: {
                'Content-Type': 'application/json',
                Authorization: `Bearer ${serviceToken2}`
            },
            timeout: 5e3
        });
    }
...
// src/services/ordersApiClient.ts
var OrdersApiClient = class {
    client;
    constructor(baseURL, serviceToken2) {
        this.client = axios_default.create({
            baseURL,
...
var OrchestratorService = class {
    constructor(customersClient2, ordersClient2) {
        this.customersClient = customersClient2;
        this.ordersClient = ordersClient2;
    }
    async createAndConfirmOrder(request) {
        try {
...
// src/handler.ts
var customersApiBase = process.env.CUSTOMERS_API_BASE || 'http://localhost:3001';
var ordersApiBase = process.env.ORDERS_API_BASE || 'http://localhost:3002';
var serviceToken = process.env.SERVICE_TOKEN || 'your-service-token-change-in-production';
var customersClient = new CustomersApiClient(customersApiBase, serviceToken);
var ordersClient = new OrdersApiClient(ordersApiBase, serviceToken);
var orchestratorService = new OrchestratorService(customersClient, ordersClient);
var createAndConfirmOrder = async (event) => {
