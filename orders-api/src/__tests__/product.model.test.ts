...
describe('ProductModel', () => {
    ...
    describe('findById', () => {
        it('should return a product by id', async () => {
            ...
            expect(pool.execute).toHaveBeenCalledWith('SELECT * FROM products WHERE id = ?', [1]);
        });
    ...
    describe('findBySku', () => {
        it('should return a product by SKU', async () => {
            ...
            expect(result).toEqual(mockProduct);
            expect(pool.execute).toHaveBeenCalledWith('SELECT * FROM products WHERE sku = ?', [
                'PROD-ABC-123'
            ]);
        });
